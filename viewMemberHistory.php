...
<body style="background-color:#273746;">
	...
	<form id="myForm" method="post">		
		...
		<div>
			<Center><label id="lblGreetings" style="color:#0DBEF9; font-size:2em;">USER'S HISTORY</label></center>
		</div>
		<div class="container-fluid" style="color:#D7DBDD;">  
			...
			$result = mysqli_query($connect,"Select * from tblogin where User_type = 'Member'");
			...
			{									
				...
				{	
					$strSessionId	=$row['id'];		
					$strTitle =$row['full_name'];
					$strDate =$row['user_type'];
					$strTime =$row['user_id'];
					$strFee =$row['email'];
					$strNotes =$row['entry_level'];
					$td='';
					...
					$strTableData = "$strTableData <table border='0'><tr><td style=\"WIDTH: 90px;color:#D7DBDD;font-style:bold\">Id</td>
					<td style=\"WIDTH: 20px;color:#D7DBDD;font-style:bold\"> : </td>
					<td style=\"WIDTH: 200px;color:#D7DBDD;font-style:bold\">$strSessionId</td></tr>
					<tr><td style=\"WIDTH: 90px;color:#D7DBDD;font-style:bold\">Full Name</td>
					<td style=\"WIDTH: 20px;color:#D7DBDD;font-style:bold\"> : </td>
					<td style=\"WIDTH: 200px;color:#D7DBDD;font-style:bold\">$strTitle</td></tr>
					<tr><td style=\"WIDTH: 90px;color:#D7DBDD;font-style:bold\">User ID</td>
					<td style=\"WIDTH: 20px;color:#D7DBDD;font-style:bold\"> : </td>
					<td style=\"WIDTH: 200px;color:#D7DBDD;font-style:bold\">$strTime</td></tr>
					<tr><td style=\"WIDTH: 90px;color:#D7DBDD;font-style:bold\">User Type</td>
					<td style=\"WIDTH: 20px;color:#D7DBDD;font-style:bold\"> : </td>
					<td style=\"WIDTH: 200px;color:#D7DBDD;font-style:bold\">$strDate</td></tr>
					<tr><td style=\"WIDTH: 90px;color:#D7DBDD;font-style:bold\">Email</td>
					<td style=\"WIDTH: 20px;color:#D7DBDD;font-style:bold\"> : </td>
					<td style=\"WIDTH: 200px;color:#D7DBDD;font-style:bold\">$strFee</td></tr>
					<tr><td style=\"WIDTH: 90px;color:#D7DBDD;font-style:bold\">Entry Level</td>
					<td style=\"WIDTH: 20px;color:#D7DBDD;font-style:bold\"> : </td>
					<td style=\"WIDTH: 200px;color:#D7DBDD;font-style:bold\">$strNotes</td></tr></table></br>"; 		
